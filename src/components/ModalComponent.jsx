    ...
    getFatData = () => {
        ...
        arrayWithECLdata.forEach( (ecl) => {
            ...
            if (ecl.conceptId === "1118951000202108") {
                ...
                let fatUrl = "https://demo.fat.terminologi.ehelse.no/api/medicines/clinical-drugs/" + ecl.conceptId;
                let params = {
                    method: "GET",
                    headers: {
                        "accept": "text/plain",
                        "request-context": "appId=cid-v1:c310e22f-57ce-4073-ace2-07613f194848",
                        "server": "Kestrel" 
                    }
                };
